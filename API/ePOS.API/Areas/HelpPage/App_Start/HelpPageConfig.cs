...
namespace WebApi.Areas.HelpPage
{
    public class MyApiExplorer : ApiExplorer
    {
        ...
        public override bool ShouldExploreController(string controllerVariableValue,
            ...
            System.Web.Http.Routing.IHttpRoute route)
        {
            if (route.RouteTemplate.StartsWith("v1/pub", StringComparison.OrdinalIgnoreCase) ||
                route.RouteTemplate.StartsWith("v1/WebCodeApi", StringComparison.OrdinalIgnoreCase))
            {
                return false;
            }
    ...
    public static class HelpPageConfig
    {
        ...
        public static void Register(HttpConfiguration config)
        {
            ...
            config.SetDocumentationProvider(new XmlDocumentationProvider(HttpContext.Current.Server.MapPath("~/App_Data/ApiDoc.xml")));
